	...
	<div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb30">
                        <div class="tour-booking-form">
                            <form action="<?php echo e(route('donormalbooking')); ?>" method="POST" role="form">
                            	<?php echo csrf_field(); ?>
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="select">
                                                <select id="select" name="package_id" class="form-control">
                                                    ...
                                                    <option value="<?php echo e($pac->package_id); ?>"><?php echo e($pac->package_name); ?></option>
...
<?php echo $__env->make('frontend.partials.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/travel/resources/views/frontend/layouts/normalbooking.blade.php ENDPATH**/ ?>
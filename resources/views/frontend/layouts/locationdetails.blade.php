...
<div class="row detail">
          <div class="col-12 col-sm-12 col-md-12 col-lg-4 p-0">
            <div class="ribbon"><span> {{$package->loc->location_name}} </span></div>
            <img src="{{url('/user/packages').'/'.$package->image1}}" alt="">
          </div>
            ...
            <div class="detail-box">
              ...
              <p>
                <div class="offer">
                    ...
                    <span class="offer-text-2">{{$package->loc->location_name}}</span>
                </div>
              </p>
              <ul>
              ...
              <p><strong><i class="fas fa-book"></i> Details: </strong>{{$package->details}} <a href="#" data-toggle="collapse" data-target="#elig-box">show more</a></p>
              <h6><strong><i class="fa fa-clock"></i> Created Date</strong> {{$package->created_at}} <span>Cost: {{$package->price}}/- <a href="{{route('singlepackage',$package->package_id)}}" class="btn btn-primary" style="font-size: 12px;">Check for more Details</a></span></h6>
            </div>
          </div>

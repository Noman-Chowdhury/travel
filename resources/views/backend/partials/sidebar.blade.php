                    ...
                    <ul class="collapsible" data-collapsible="accordion">
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-user" aria-hidden="true"></i> Users</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    <li><a href="{{route('userlist')}}">All Users</a>
                                    </li>
                        ...
                        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-umbrella" aria-hidden="true"></i> Tour Packages</a>
                            <div class="collapsible-body left-sub-menu">
                                <ul>
                                    ...
                                    <li><a href="{{route('admin.location')}}">All Locations</a>
                                    </li>
                                    <li><a href=" ">Add Locations</a>
                                    </li>
                                    <li><a href=" {{route('admin.district')}}">Add District</a>
                                    </li>
                                    <li><a href="{{route('admin.showdistrict')}} ">View All Districts</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                       <!--  <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-h-square" aria-hidden="true"></i> Hotels</a>
                        ...
                        <li><a href="{{route('cars')}}" class="collapsible-header"><i class="fa fa-picture-o" aria-hidden="true"></i> Transport</a>
                           
                        </li> 

                        <li><a href="{{route('guide')}}" class="collapsible-header"><i class="fa fa-picture-o" aria-hidden="true"></i> Tour Guide</a>
                           
                        </li>

                        <li><a href="{{route('userbooking')}}" class="collapsible-header"><i class="fa fa-picture-o" aria-hidden="true"></i> Booking</a>
                           
                        </li>

                        <li><a href="{{route('userfeedback')}}" class="collapsible-header"><i class="fa fa-picture-o" aria-hidden="true"></i> Feedback</a>
                       ...
                       <!--  <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-tags" aria-hidden="true"></i> Offers</a>
                        ...
                        <li><a href="{{route('home')}}"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Website</a>
                        </li>
